        ...
        <div className="card mt-3 mx-auto">
          {apiData.main ? (
            <div className="card-body text-center">
              ...
              />
              <p className="h2">
                {kelvinToFarenheint(apiData.main.temp)}&deg; F
              </p>
              <p className="h5">
                <FontAwesomeIcon
                  icon={faMapMarkerAlt}
              ...
              <div className="row mt-4">
                <div className="col-md-6">
                  <p>
                    ...
                    />{" "}
                    <strong>
                      {kelvinToFarenheint(apiData.main.temp_min)}&deg; F
                    </strong>
                  </p>
                  <p>
                    <FontAwesomeIcon
                    ...
                    />{" "}
                    <strong>
                      {kelvinToFarenheint(apiData.main.temp_max)}&deg; F
                    </strong>
                  </p>
                </div>
                <div className="col-md-6">
